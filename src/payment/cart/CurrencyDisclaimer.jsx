...
/**
 * CurrencyDisclaimer
 * it tells the user if they will be charged in GBP even though
  ...
  return (
    <div className="text-muted font-italic">
      <FormattedMessage
        ...
        description="A notification that shows if we are displaying approximate prices in the user's local currency, instead of GBP."
        values={{
          actualAmount: (
            <FormattedNumber
              value={actualAmount}
